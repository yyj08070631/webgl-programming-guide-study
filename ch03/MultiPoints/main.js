...
function main () {
    ...
    function start () {
        ...
        // canvas.onmouseup = function (e) { click(e, gl, canvas, a_Position, u_FragColor, n) }
        gl.clearColor(0.0, 0.0, 0.0, 1.0)
        gl.clear(gl.COLOR_BUFFER_BIT)
        const n = initVertexBuffers(gl, a_Position, u_FragColor)
        if (n < 0) {
    ...
    // const g_points = []
    // function click (e, gl, canvas, a_Position, u_FragColor, n) {
    //     let x = e.clientX
    //     let y = e.clientY
